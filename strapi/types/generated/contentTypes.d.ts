...
export interface ApiCategorieCategorie extends Schema.CollectionType {
  ...
  attributes: {
    ...
    peintures: Attribute.Relation<
      'api::categorie.categorie',
      'manyToMany',
      'api::peinture.peinture'
    >;
    tattoos: Attribute.Relation<
      'api::categorie.categorie',
      'manyToMany',
      'api::tattoo.tattoo'
    >;
...
export interface ApiPeinturePeinture extends Schema.CollectionType {
...
export interface ApiTattooTattoo extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::peinture.peinture': ApiPeinturePeinture;
